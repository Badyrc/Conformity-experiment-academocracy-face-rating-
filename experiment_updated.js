...
Сейчас экспериментаторы проверяют ваши ответы на задание с переформулировкой. Это займет несколько минут. Пожалуйста, сделайте 5-минутный перерыв - ниже вы увидите таймер.
        </p>
...
<p><b>После того как лицо исчезнет, в центре экрана зелёным цветом будет показана оценка большинства участников.</b></p>
<p><b>Зелёным цветом показана оценка, которую поставило большинство других участников.</b></p>
...
timeline.push({
  ...
  html: `
      <div style="text-align:left; max-width:760px; margin:0 auto; line-height:1.8;">
        <p>1. Насколько вы согласны с сообщением, которое вы видели ранее и в котором оценивалось ваше выполнение задания на переформулировку?</p>
...
timeline.push({
  ...
  html: `
      <div style="text-align:left; max-width:780px; margin:0 auto; line-height:1.8;">
        <p><b>После нажатия кнопки «Продолжить» пожалуйста, не закрывайте окно и дождитесь загрузки следующего экрана. Это может занять 10-15 секунд.</b></p>

        <p style="margin-top:18px;">1. Как вы думаете, какова была настоящая цель исследования?</p>
